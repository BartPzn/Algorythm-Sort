...
namespace Projekt3_Sortowanie
{
	class Projekt3_Sortowanie
	{
		...
		static void GrowingTableTest()
		{
			...
			//pętla po typach algorytmów sortujących
		...
		{
			//tworzenie tablicy bazowej - wypełnionej zerami
    ...
    {
        private int[] oBaseTable;

        public QuickSortRecursion(int[] oBaseTable)
        {
            this.oBaseTable = oBaseTable;
        }

        internal void MeasureSortTime(int i)
        {
            throw new NotImplementedException();
        }
    }

    internal class QuickSortIteration
    {
        internal int Pivot;
        private int[] _oBaseTable;

        public QuickSortIteration(int[] oBaseTable)
        {
            _oBaseTable = oBaseTable;
        }
